...
| SDWIS | ~160K systems | Lead, copper, arsenic | CSV | Public |
...
| OH EPA | Varies | PFAS | ArcGIS REST | Public |
| WA DOH | Varies | PFAS | ArcGIS REST | Public |
| TRI PFAS | ~2.5K facilities | PFAS releases | CSV | Public |
| DoD PFAS | ~700 sites | Military PFAS sites | CSV | Public |
| NJ Private Wells | ~10K | PFAS, metals | CSV | Public |
